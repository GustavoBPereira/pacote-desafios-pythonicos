...
def front_x(words):
    strings_start_x = [word for word in words if word[0] == 'x']
    strings_start_x.sort()
    strings_not_start_x = [word for word in words if word[0] != 'x']
    strings_not_start_x.sort()

    return strings_start_x + strings_not_start_x

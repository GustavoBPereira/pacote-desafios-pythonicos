...
def not_bad(s):
    not_possition, bad_possition = s.find('not'), s.find('bad')
    if 'bad' not in s or 'not' not in s or not_possition > bad_possition:
        return s
    return f'{s[0:not_possition]}good{s[bad_possition+3::]}'
